    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2 col-5" style="margin:auto">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small> <i class="fa fa-list"></i> Statut </small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-5" style="margin:auto">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Statut </a> </h3>
                            <div class="card-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <a data-toggle="modal" data-target=".bd-example-modal-lg" href="#"> <i class="fa fa-plus"></i> Nouveau statut </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title"> <i class="fa fa-user-plus"> </i> Nouvelle statut</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('storestatut') }}">
                        @method('post')
                        @csrf
                        <div class="row">
