    ...
    <div class="content-header">
        <div class="container">
            <div class="row col-5" style="margin:auto">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small> <i class="fa fa-list"></i> Motif de pense</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="home">Accueil</a></li>
                        <li class="breadcrumb-item active">Motif depense</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Motif depense </a> </h3>
                            <div class="card-tools">
                                <div class="input-group input-group-sm" style="width: 200px;">
                                    <a data-toggle="modal" data-target=".bd-example-modal-lg" href="#"> <i class="fa fa-plus"></i> Nouvelle motif depense </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title"> <i class="fa fa-user-plus"> </i> Nouvelle Motif depense</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('storemotifdepense') }}">
                        @method('post')
                        @csrf
                        <div class="row">
