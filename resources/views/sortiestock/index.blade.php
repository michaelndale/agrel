...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small> <i class="fa fa-list"></i> Historique sortie stock </small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('bienvenu') }}">Accueil</a></li>
                        <li class="breadcrumb-item active">Sortie de produit dans le stock</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
                                ...
                                <div class="tab-pane fade show active" id="custom-content-all" role="tabpanel" aria-labelledby="custom-content-all-tab">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        class="btn btn-primary btn-sm">Edit</a>
                                            ...
                                            <div class="col-sm">
                                                <form action="{{ route('deletestock', $Sortiestockss->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title"> <i class="fa fa-plus-circle"> </i> Nouvelle sortie en stock</h4>
                </div>
                <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <label for="example-text-input" class="col-form-label">Montant unitaire </label>
                                <input class="form-control" type="number" min="0" value="0" name="prixunite" id="prixunite" placeholder="quantite" required>
                            </div>
