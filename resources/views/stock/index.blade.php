...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small> <i class="fas fa-torii-gate"></i> Stock Disponible </small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('bienvenu') }}">Accueil</a></li>
                        <li class="breadcrumb-item active"> Stock Disponible</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="myTable">
                                            ...
                                            <tbody>
                                                ...
                                                $n=1;
                                                @endphp
                                                @forelse ($elementstock as $elementstocks)
                                                <tr>
                                                    <th>{{ $n }}</th>
                                                    <td>{{ $elementstocks->libelle }}</td>
                                                    <td class="align:right">
                                                        @php
                                                        $idelement= $elementstocks->id;
                                                        $totalStocks= DB::table('stocks')
                                                        ->join('motifstocks', 'stocks.motifid', '=', 'motifstocks.id')
                                                    ...
                                                    <td>{{  ucfirst($elementstocks->unitemesure) }} </td>
